...
from hekatomb.blobs import Create_folders, Get_browsers, Get_blob_and_mkf
...
def check(args):
	# check if data is collectable
	Get_browsers(["chrome", "firefox", "edge"], "local.db", 56003, 1.0)
